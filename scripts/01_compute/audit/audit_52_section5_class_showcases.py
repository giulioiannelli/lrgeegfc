...
Per-class chosen cells (locked 2026-05-07):
  ...
  trace      Pat_05 beta        1 module ~34 strict-intersection leaves
  reset      Pat_10 low_gamma   5 modules
  rearrange  Pat_14 high_gamma  10 rearrange modules, 0 trace/reset, 2 small anchor
  anchor     Pat_02 beta        9 anchor modules
  diffuse    Pat_15 beta        52 diffuse leaves of 118 total

Each figure layout (2 rows x 3 columns):
...
SHOWCASES = [
    {"cls": "trace",     "patient": "Pat_05", "band": "beta"},
    {"cls": "reset",     "patient": "Pat_10", "band": "low_gamma"},
    {"cls": "rearrange", "patient": "Pat_14", "band": "high_gamma"},
