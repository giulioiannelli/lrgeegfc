#!/usr/bin/env python3
"""Audit round-3 Section-5 redos — KC decomposition + topology + dendrogram eye-proofs + cohort variants.

Split out of audit_round3_section5_redo.py on 2026-05-29 (Phase 4-B
split 2/7). Imports shared constants + helpers from
_audit_round3_shared and runs: redo3, redo6, redo7, redo8, redo9, redo10.
"""
...
from _audit_round3_shared import (
    _best_jaccard_partner, _clade_leaf_xrange, _draw_clade,
    _enumerate_clades, _max_jaccard_match, _reorder_linkage_to_match,
)
...
def main() -> None:
    ...
    print(f"[kc] done · outputs at {OUT}")
