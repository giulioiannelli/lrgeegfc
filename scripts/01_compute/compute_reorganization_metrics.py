...
from lrg_eegfc.config.paths import LRG_CACHE as DEFAULT_LRG_CACHE, SEEG_DATAPATH
...
def main() -> int:
    ...
    parser.add_argument("--cache-root", type=Path, default=DEFAULT_LRG_CACHE)
    ...
    patients = args.patients or list_patients(SEEG_DATAPATH)
