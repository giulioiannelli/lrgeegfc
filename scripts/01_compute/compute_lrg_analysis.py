...
Usage:
    ...
    python scripts/py/compute_lrg_analysis.py --fc-method corr

    # Compute LRG for MSC matrices
    python scripts/py/compute_lrg_analysis.py --fc-method msc

    # Specific patients
    python scripts/py/compute_lrg_analysis.py --fc-method corr --patients Pat_02 Pat_03

    # Custom entropy parameters
    python scripts/py/compute_lrg_analysis.py --fc-method corr --entropy-steps 600 --verbose
"""
...
from lrg_eegfc.config.paths import LRG_CACHE, LRG_DEV_CACHE
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=LRG_CACHE,
        help="Cache directory (default: data/cache/lrg)"
    )
    parser.add_argument(
        "--overwrite",
        action="store_true",
    ...
    if args.filter_time is not None and args.filter_time > 0 and args.cache_root == LRG_CACHE:
        args.cache_root = LRG_DEV_CACHE
