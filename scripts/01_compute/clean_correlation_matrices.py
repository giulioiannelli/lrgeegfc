...
Usage:
    # Clean all patients
    python scripts/py/clean_correlation_matrices.py --verbose

    # Specific patients
    python scripts/py/clean_correlation_matrices.py --patients Pat_02 Pat_03 --verbose

    # Force recompute
    python scripts/py/clean_correlation_matrices.py --overwrite --verbose
"""
...
from lrg_eegfc.config.paths import CORR_CACHE
