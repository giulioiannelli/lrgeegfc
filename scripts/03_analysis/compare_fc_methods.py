...
Usage:
    ...
    python scripts/py/compare_fc_methods.py

    # Specific patients
    python scripts/py/compare_fc_methods.py --patients Pat_02 Pat_03

    # Save to CSV
    python scripts/py/compare_fc_methods.py --output results/fc_comparison.csv

    # Memory effects analysis (pre vs post)
    python scripts/py/compare_fc_methods.py --mode memory --fc-method corr
"""
...
from lrg_eegfc.config.const import BRAIN_BANDS, PHASE_LABELS, PATIENTS_4PHASE
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=LRG_CACHE,
        help="LRG cache directory (default: data/cache/lrg)"
    )
    ...
    if len(df) > 0:
        ...
        if args.mode == "fc-methods":
            print("  python scripts/py/compute_lrg_analysis.py --fc-method corr")
            print("  python scripts/py/compute_lrg_analysis.py --fc-method msc")
        else:
            print(f"  python scripts/py/compute_lrg_analysis.py --fc-method {args.fc_method}")
