...
Figures 7–11: comparisons across patients, phases, and bands.
  ...
  Fig 11: fig_C_tau_across_bands.pdf        — C(τ) across 6 bands (Pat_02, rsPre)
...
NPERSEG = 4096
FC_METHOD = "msc"
OUTPUT_DIR = ROOT / "data" / "figures" / "report_mslcd_section" / "cross"
...
PHASE_COLORS = {"rsPre": "#4C72B0", "taskLearn": "#55A868",
                "taskTest": "#C44E52", "rsPost": "#8172B3"}
PATIENT_COLORS = {
...
CROSS_PHASE = "rsPre"      # for cross-patient and cross-band
...
# ======================================================================
# FIG 11: C(τ) across bands (Pat_02, rsPre)
# ======================================================================
