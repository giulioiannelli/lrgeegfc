...
COH_CACHE = ROOT / "data" / "fc_fig_cache"
...
for patient in PATIENTS:
    OUTPUT_DIR = ROOT / "data" / "figures" / "report_fc_section" / patient
...
# ── All-patients rsPre comparison ─────────────────────────────────────
print("Adjacency heatmaps (all patients, rsPre)...")
fig, axes = plt.subplots(
...
out = ROOT / "data" / "figures" / "report_fc_section" / "fig_adjacency_heatmaps_all_patients_rsPre.pdf"
fig.savefig(out, bbox_inches="tight")
plt.close(fig)
print(f"  Saved: {out}")
...
out = ROOT / "data" / "figures" / "report_fc_section" / f"fig_network_metrics_cross_patient_{PHASE}.pdf"
fig.savefig(out, bbox_inches="tight")
plt.close(fig)
print(f"  Saved: {out}")
...
out = ROOT / "data" / "figures" / "report_fc_section" / f"fig_metrics_cross_patient_{PHASE}.pdf"
fig.savefig(out, bbox_inches="tight")
plt.close(fig)
print(f"  Saved: {out}")
