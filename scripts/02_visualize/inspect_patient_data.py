...
Usage:
    python scripts/py/inspect_patient_data.py
    python scripts/py/inspect_patient_data.py --output data_report.txt
    python scripts/py/inspect_patient_data.py --patients Pat_02 Pat_03
"""
