...
Examples
--------
# Generate combined summary for Pat_02 rest_pre beta
python scripts/py/visualize_correlation.py --patient Pat_02 --phase rest_pre --band beta --plot-type summary --verbose

# Generate network visualization only (uncleaned)
python scripts/py/visualize_correlation.py --patient Pat_02 --phase rest_pre --band beta --plot-type network --verbose

# Batch mode: generate all plots for all bands/phases of a patient
python scripts/py/visualize_correlation.py --patient Pat_02 --batch --verbose

# Generate Marchenko-Pastur comparison
python scripts/py/visualize_correlation.py --patient Pat_02 --phase rest_pre --band beta --plot-type mp --verbose
"""
...
def main():
    ...
    parser.add_argument(
        ...
        type=Path,
        default=CORR_CACHE,
        help='Root directory for correlation cache',
    )
    parser.add_argument(
        '--output-dir',
        type=Path,
        default=FIGURES_ROOT / "correlation",
