...
from lrg_eegfc.config.paths import CORR_CACHE, FIGURES_ROOT, LRG_CACHE, MSC_CACHE, SEEG_DATAPATH
...
def main():
    ...
    parser.add_argument("--phase", help="Phase (e.g., rest_pre)")
    ...
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=FIGURES_ROOT / "metastable",
