...
def main() -> int:
    ...
    parser.add_argument("--cache-root", type=Path, default=Path("data/corr_cache"))
    parser.add_argument(
        "--output-dir",
        type=Path,
        default=Path("data/figures/cleaning"),
    )
    ...
    patients = _resolve_list(args.patients, list_patients(Path("data/stereoeeg_patients")))
