...
%     Method PARAMETERS kept (four phases, single working scale τ_min = 1/λ_max, matched-strength gate).
...
%   - SCALE: read at τ_min = 1/λ_max ONLY. The τ-sweep multiscale panel was DROPPED
%     2026-07-09 (PI call) — no meaningful multiscale across τ in a fully-connected
%     network; the dendrogram hierarchy carries the multiscale content at the single τ.
%     Do NOT reintroduce a τ≈2.6 mesoscale claim (peak already retracted 2026-07-07).
...
%   null — RESULT DROPPED 2026-07-09). Results: R2.1 (inferred-not-seen), R2.4 (duration);
%   R2.2 (τ-sweep mesoscale/multiscale) retired — results_paragraphs/archive/2026-07/R2.2_mesoscale-integration.tex.
% =====================================================================
...
% τ-sweep "multiscale" panel DROPPED 2026-07-09 (PI call). Below now mirrors the live
% overleaf/methods.tex ssec:methods_arc: read at τ_min ONLY; multiscale via the single-τ
% dendrogram hierarchy, not a τ-sweep. Do NOT reintroduce the c≈2.6 mesoscale reading.
