...
\begin{figure*}[p]
    ...
    \caption{\textbf{The same diffusion propagator that carries the cognitive trace
        ...
        (\(0.5\) = strength alone): cohort-median \gls{auc} \(0.80\) in \(\delta\),
        \(0.74\) in \(\lowgamma\), \(0.69\) in \(\beta\), \(0.60\) in \(\alpha\), each
        clearing a matched-strength label-shuffle null (grey band; \(0\) of \(300\)
        surrogates reached the observed value) and holding in \(7\)/\(6\)/\(7\)/\(6\)
        of \(10\) patients (green = beats own null).
