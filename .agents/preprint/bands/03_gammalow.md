...
| C5 epi-X | ✓ **EMERGES** (audit_77, 2026-06-05): p=0.024, 8/10, median +0.174, Pat_13/14 sign-flip — elevated to primary lens (PI 2026-06-05) | cohort gate held p_mass^epi-X = 0.030; mass contracts; LOO under epi-X fragile (Pat_05 = 0.159) | cophenet epi-X now a primary γ_l finding; Grassmann epi-X secondary |
