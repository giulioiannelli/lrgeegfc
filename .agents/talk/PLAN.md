...
| 05→19 | multiscale-brain result — RE-HOMED off 05 (don't spoil results on the gap slide) | `data/reports/rho_sym_band_map/fig_rho_sym_band_map.pdf` | [x] — F 07-11 · slide-6 is NOT a montage (grid cells + nested rhythms) → held for slide-19 |
