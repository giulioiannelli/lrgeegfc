...
1. TITLE
The Multiscale Shape of Neural Inference

2. MAIN CONCEPT
- Fingerprints of cognition — and of epilepsy — hidden in higher-order features of brain networks.
- One talk, one operator (a diffusion view of connectivity), two payoffs: a cognitive trace and a clinical marker.

3. ON-SLIDE TEXT
The Multiscale Shape of Neural Inference
How fingerprints of cognition and epilepsy hide in the higher-order features of brain networks
Giulio Iannelli
Iannelli, G. et al. (2026). Multiscale sustained states in brain networks underpin cognitive tasks and reveal hidden connectivity patterns of epileptogenic niches. [Ongoing]

(shorter subtitle alternative, if you prefer: "Fingerprints of cognition and epilepsy in higher-order brain-network features")
