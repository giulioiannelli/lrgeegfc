...
## 8. Results still landing

N3 (free + order-preserving), N4, the functional calibration, and the functional N1 were running when this report was first written; their sections are filled in below as they complete.
